                ...
                <div class="row">
                    <div class="col-md-6 chapter-title">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sub_item_title_${subItemCount}" name="sub_items[${subItemCount}][quest_chapter_title]" value="{{ old('sub_items.${subItemCount}.quest_chapter_title') }}" required>
                        </div>
                        <div class="form-group">
                            <label for="sub_item_description_${subItemCount}">Description:</label>
                            <textarea class="form-control" id="sub_item_description_${subItemCount}" name="sub_items[${subItemCount}][description]" rows="4" required>{{ old('sub_items.${subItemCount}.description') }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="video_${subItemCount}">Video Link:</label>
                            <input type="url" class="form-control" id="video_${subItemCount}" name="sub_items[${subItemCount}][video]" value="{{ old('sub_items.${subItemCount}.video') }}" onchange="loadVideo(${subItemCount})">
