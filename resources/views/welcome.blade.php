            ...
            <div class="row g-4">
                @foreach($quests as $quest)
                    <div class="col-12 col-md-6 col-lg-3">
                        <a href="{{ route('quests.show', $quest) }}" class="text-decoration-none">
                            <div class="card h-100 shadow-sm" style="border: 1px solid #000000; background-color: #ffffff;">
                                ...
                                <!-- Category Badge -->
                                <div class="px-2 py-2">
                                    @if($quest->categories && $quest->categories->count() > 0)
                                        <a href="{{ route('quests.category', $quest->categories->first()) }}" class="text-decoration-none">
                                            <span class="badge" style="background-color: {{ $quest->categories->first()->color }}">
                                                {{ $quest->categories->first()->name }}
                                            </span>
                                        </a>
                                    @else
                                        <span class="badge">
