            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        {{-- Nickname --}}
                        <div class="row mb-3">
                            <label for="player_nickname" class="col-md-4 col-form-label text-md-end">{{ __('Nickname') }}</label>

                            <div class="col-md-6">
                                <input id="player_nickname" type="text" class="form-control @error('player_nickname') is-invalid @enderror" name="player_nickname" value="{{ old('player_nickname') }}" required autocomplete="player_nickname" autofocus>
